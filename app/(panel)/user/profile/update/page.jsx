...
const UpdateProfilePage = () => {
  const { userData, handleUpdateUserSubmit } = useUserContextHook();
  ...
  return (
    <>
      <main className="md:w-2/3 lg:w-3/4 px-4">
        ...
        >
          <form
            onSubmit={(e) => handleUpdateUserSubmit(e, fullName, email, avatar)}
          >
              ...
              <div className="mb-4 flex flex-col md:flex-row">
                <div className="flex items-center mb-4 space-x-3 mt-4 cursor-pointer md:w-1/5 lg:w-1/4">
                  <img
                    ...
                    src={
                      previewImage ? previewImage : "/images/default_avatar.png"
                    }
                  />
                </div>
