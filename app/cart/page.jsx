  ...
  return (
    <>
      ...
      <section className="py-10">
        {/* Show cart data id cart item available */}
        {cartData?.length > 0 ? (
          <div className="container max-w-screen-xl mx-auto px-4">
                      ...
                      <div key={cartItem?.id}>
                        <div className="flex flex-wrap lg:flex-row gap-5  mb-4">
                          ...
                          <div className="flex-auto">
                            <div className="float-right flex flex-col justify-center items-center gap-2">
                              <button
                                className="px-2 py-1 inline-block text-white text-sm bg-green-600 shadow-sm border border-gray-200 rounded-md hover:bg-green-700 cursor-pointer disabled:bg-gray-300 disabled:hover:bg-gray-300 disabled:cursor-default"
                                disabled={cartItem.isQuantityChanged === false}
                                onClick={() => updateCart(cartItem?.id)}
                              >
                                Update
                              </button>
                              <button
                                className="px-2 py-1 inline-block text-white text-sm bg-red-600 shadow-sm border border-gray-200 rounded-md hover:bg-red-700 cursor-pointer"
                                onClick={() => deleteItem(cartItem?.id)}
                              >
                                Delete
                              </button>
                ...
                <article className="border border-gray-200 bg-white shadow-sm rounded mb-5 p-3 lg:p-5">
                  <ul className="mb-5">
                    ...
                    <li className="flex justify-between text-gray-600  mb-1">
                      ...
                      <span className="text-black-500">{totalUnits} Units</span>
                    </li>
                    <li className="flex justify-between text-gray-600  mb-1">
                      <span>GST (18%):</span>
                      <span>${gst}</span>
